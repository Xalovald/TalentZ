...
class CustomImages {
  ...
  static Image iphone14({double height = 10, double width = 10}) {
    return Image.asset('lib/assets/images/iPhone14.png', height: height, width: width,);
  }
  static Image pastillesTombantes({double height = 10, double width = 10}) {
    return Image.asset('lib/assets/images/pastillesTombantes.png', height: height, width: width,);
  }
  static Image line1({double height = 10, double width = 10}) {
    return Image.asset('lib/assets/images/line1.png', height: height, width: width,);
  }
  static Image line2({double height = 10, double width = 10}) {
    return Image.asset('lib/assets/images/line2.png', height: height, width: width,);
  }
  static Image line3({double height = 10, double width = 10}) {
    return Image.asset('lib/assets/images/line3.png', height: height, width: width,);
  }
  static Image messages({double height = 10, double width = 10}) {
    return Image.asset('lib/assets/images/messages.png', height: height, width: width,);
  }
