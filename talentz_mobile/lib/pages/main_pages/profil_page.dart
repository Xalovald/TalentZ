...
class _ProfilPageState extends State<ProfilPage> {
  ...
  void getHttp() async {
    ...
    try {
      Response response = await dio.get("/users/${await CustomHelpers.getCurrentId()}");
      setState(() {
        data = response.data;
      });
    } catch (e) {
          ...
          child: Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                border: Border(bottom: BorderSide(color: CustomColors.lightGrey2())),
              ),
              child: Row(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              data!["role"] == "candidat" ? data!["firstName"] + " " + data!["lastName"] : data!["companyName"],
                              style: TextStyle(
                                fontSize: 14,
